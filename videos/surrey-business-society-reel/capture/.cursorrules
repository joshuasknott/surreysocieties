# Home | Surrey Business Society

Source: http://localhost:4322/
...
| `extracted/tokens.json` | Design tokens: 19 colors, 3 fonts, 14 headings, 3 CTAs |
...
- **Colors**: #FFFCF6 (bg-light), #F5F0E7 (bg-light), #071A2D (accent), #FFFAF1 (bg-light), #0F172A (accent), #D7A845 (accent), #861F35 (accent), #C9A84C (accent), #FFFFFF (bg-light), #DDD9D1 (surface-light)
- **Fonts**: Inter (400,500,600,700,800,900), DM Sans (400,500,600,700,800), Playfair Display (600,700,800)
