...
| `extracted/tokens.json` | Design tokens: 20 colors, 2 fonts, 15 headings, 3 CTAs |
...
- **Colors**: #FFF8E8 (bg-light), #031426 (accent), #CBD8DF (surface-light), #07162D (accent), #D4AF37 (accent), #F1DC91 (surface-light), #021227 (accent), #0B5F76 (accent), #00B4D8 (accent), #02112B (accent)
- **Fonts**: Inter (400,500,600,700,800,850,900), Fraunces (400,650,700,750,850)
