# Home — Surrey Artificial Intelligence Society
...
| `extracted/tokens.json` | Design tokens: 20 colors, 2 fonts, 11 headings, 5 CTAs |
...
- **Colors**: #172329 (accent), #F7F8F3 (bg-light), #FFFFFF (bg-light), #5E6C70 (neutral), #3F6D80 (accent), #DCE4E0 (surface-light), #BFCBC8 (surface-light), #0B0F19 (accent), #EEF2EF (bg-light), #10B981 (accent)
- **Fonts**: Inter (400,500,600,700,750,800,850,900), Fira Code (400,600)
